...
bool xtouch_wifi_setup()
{
    ...
    ConsoleLog.println(F("[XTOUCH][CONNECTION] Connecting to WiFi .."));
    delay(1000);
    ...
    lv_task_handler();
    delay(1000);
    ConsoleLog.print(F("[XTOUCH][CONNECTION] Connected to the WiFi network with IP: "));
    ConsoleLog.println(WiFi.localIP());
