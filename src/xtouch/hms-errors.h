...
const char *hms_error_codes[] PROGMEM = {
...
const char *hms_error_values[] PROGMEM = {
    ...
    "The build plate is not placed properly. Please adjust it.",
    "The build plate is not placed properly. Please adjust it.",
    "Heatbed homing abnormal. There may be a bulge on the heated bed or the nozzle tip is not clean.",
    ...
    "The resonance frequency of the X axis differ much from last calibration. Please clean the carbon rod and rerun the machine calibration later.",
    "The resonance frequency of the Y axis differs greatly from the last calibration. Please clean the carbon rod and rerun the machine calibration later.",
    ...
    "The print job has expired. Please resend the print job.",
    ...
    "The nozzle is clogged up with filaments.",
    ...
    "Failed to extrude AMS2 Slot1 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS3 Slot1 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS4 Slot1 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS1 Slot2 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS2 Slot2 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS3 Slot2 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS4 Slot2 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS1 Slot3 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS2 Slot3 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS3 Slot3 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS4 Slot3 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
    "Failed to extrude AMS1 Slot4 filament, the extruder may be clogged, or the filament may be too thin, causing the extruder slipping.",
...
uint16_t device_error_length = 251;
...
const char *device_error_values[] PROGMEM = {
    ...
    "Failed to pull out the filament from the extruder. Please check whether the extruder is clogged or whether the filament is broken inside extruder. After troubleshooting, click the retry button.",
    ...
    "Filament is still loaded from the AMS when it has been disabled. Please unload AMS filament, load from spool holder, and restart print job.",
    "Filament is still loaded from the AMS when it has been disabled. Please unload AMS filament, load from spool holder, and restart print job.",
    "Failed to check the filament location in the tool head, please refer to the HMS. After trouble shooting, click the \"Retry\" button.",
    "Failed to check the filament location in the tool head, please refer to the HMS. After trouble shooting, click the \"Retry\" button.",
    "Failed to check the filament location in the tool head, please refer to the HMS. After trouble shooting, click the \"Retry\" button.",
    "Failed to check the filament location in the tool head, please refer to the HMS. After trouble shooting, click the \"Retry\" button.",
    ...
    "The printing command is overdue.",
    "The nozzle is covered with filaments, or the build plate is put in crooked. Please clean the nozzle or adjust the position of the build plate. Then you can tap \"Resume\" to resume the print job.",
    "The filament has ran out, please load new filament in the \"filament\" page, then return back to print page and tap \"Resume\" to resume the print job.",
    "Binding failed. Please retry or restart the printer and retry.",
    "Binding configuration information parsing failed,  please try again.",
    "The printer has already been bound. Please unbind it and try again.",
    "Cloud access failed. Possible reasons include network instability caused by interference, inability to access the internet, or router firewall configuration restrictions. You can try moving the printer closer to the router or checking the router configuration and then try again.",
    ...
    "QR code binding is in progress, and device discovery binding cannot be performed. You can scan the QR code on the screen for binding, or exit the QR code display page on screen and try device discovery binding.",
    ...
    "Your APP region is not matched with you printer, please download APP in corresponding region and register account again.",
    "Failed to pull back the filament from the toolhead. Please check if the filament is stuck or the filament is broken inside extruder. After trouble shooting, click the retry button.",
    "Failed to pull back the filament from the toolhead. Please check if the filament is stuck or the filament is broken inside extruder. After trouble shooting, click the retry button.",
    "Failed to pull back the filament from the toolhead. Please check if the filament is stuck or the filament is broken inside extruder. After trouble shooting, click the retry button.",
    "Failed to pull back the filament from the toolhead. Please check if the filament is stuck or the filament is broken inside extruder. After trouble shooting, click the retry button.",
    "Timelapse recording may affect the print quality, please confirm whether to enabled it.",
    ...
    "The device is in the process of binding and cannot respond to binding request."};
...
const char *getValueByKey(const char *key, const char *keys[], const char *values[], int numEntries)
{
    ...
    {
        if (strcmp_P(key, (PGM_P)pgm_read_word(&keys[i])) == 0)
        {
            return (const char *)pgm_read_word(&values[i]);
        }
    }
